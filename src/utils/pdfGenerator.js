...
export const generatePDF = async () => {
  ...
  try {
    ...
    // Create a light background for contact section
    pdf.setFillColor(248, 249, 250);
    pdf.rect(margin, currentY - 2, contentWidth, 12, 'F');
    
    // Left column
    pdf.text(`sakundepranit@gmail.com`, margin + 2, currentY + 2);
    pdf.text(`Pune, Maharashtra, India`, margin + 2, currentY + 7);
    
    // Right column  
    pdf.text(`+91 9145130014`, margin + 100, currentY + 2);
    pdf.text(`linkedin.com/in/pranit-s-2b2624136`, margin + 100, currentY + 7);
