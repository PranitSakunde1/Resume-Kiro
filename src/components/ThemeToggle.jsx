...
const ThemeToggle = () => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="fixed top-6 right-6 z-50 p-3 bg-white/80 dark:bg-dark-800/80 backdrop-blur-md border border-gray-200/50 dark:border-dark-700/50 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 group"
