...
const Skills = () => {
  ...
  return (
    <section id="skills" className="py-20 bg-gradient-to-br from-gray-50/50 via-white/50 to-primary-50/50 dark:from-gray-900/50 dark:via-gray-800/50 dark:to-gray-900/50 relative overflow-hidden transition-colors duration-300">
          ...
          {Object.entries(skills).map(([category, skillList], index) => {
            ...
            return (
              <div
                key={category}
                data-index={index}
                className={`skill-card group bg-white dark:bg-dark-900 rounded-2xl p-4 sm:p-6 shadow-xl hover:shadow-2xl transition-all duration-500 hover:transform hover:scale-105 border border-gray-100 dark:border-dark-700 relative overflow-hidden ${
