...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-20 bg-gradient-to-br from-gray-50/50 via-white/50 to-purple-50/50 dark:from-gray-900/50 dark:via-gray-800/50 dark:to-gray-900/50 relative overflow-hidden transition-colors duration-300">
