        ...
        <div className="mt-16 text-center animate-fade-in">
          <div className="bg-white dark:bg-dark-900 rounded-xl p-8 shadow-lg max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
              ...
              Currently leading technical teams with expertise in <span className="text-primary-600 font-medium">HLD/LLD design</span> and 
              <span className="text-primary-600 font-medium"> system architecture</span>. 
              Expanding expertise in <span className="text-primary-600 font-medium">GenAI and MCP technologies</span> 
