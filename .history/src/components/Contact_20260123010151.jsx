...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-gray-50/50 via-white/50 to-primary-50/50 dark:from-dark-900/50 dark:via-dark-800/50 dark:to-dark-900/50 relative overflow-hidden">
