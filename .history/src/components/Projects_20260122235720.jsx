                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-dark-700">
                    <span className="text-xs text-gray-500 dark:text-gray-400">
                      {project.isLeadership ? 'Leadership Project' : 'Enterprise Project'}
                    </span>
        ...
        <div className="mt-16 text-center animate-fade-in">
          <div className="bg-white dark:bg-dark-900 rounded-xl p-8 shadow-lg max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
              These projects represent my contribution to HP's enterprise ecosystem and healthcare solutions, 
              serving thousands of users and managing critical business operations. 
              As a Technical Lead, I've successfully managed cross-functional teams, designed system architectures, 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-primary-600 dark:text-primary-400 mb-1">6+</div>
                <div className="text-sm text-gray-600 dark:text-gray-400">Technologies Used</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-primary-600 dark:text-primary-400 mb-1">50K+</div>
