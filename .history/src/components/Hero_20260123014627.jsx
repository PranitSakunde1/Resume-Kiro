      ...
      <div className="container-max section-padding relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-24">
          ...
          <div className={`flex-1 text-center lg:text-left transition-all duration-1000 ${isLoaded ? 'animate-slide-in-left' : 'opacity-0'}`}>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-3 sm:gap-6 mb-10 text-gray-600 dark:text-gray-400">
              <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-white/50 dark:bg-gray-800/50 rounded-xl backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 hover:scale-105 transition-transform text-sm sm:text-base">
                <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-primary-500" />
                <span className="font-medium">{personal.location}</span>
              </div>
              <a href={`mailto:${personal.email}`} className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-white/50 dark:bg-gray-800/50 rounded-xl backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 hover:scale-105 transition-transform hover:text-primary-500 text-sm sm:text-base">
                <Mail className="w-4 h-4 sm:w-5 sm:h-5 text-primary-500" />
                <span className="font-medium break-all sm:break-normal">{personal.email}</span>
              </a>
              <a href={`tel:${personal.phone}`} className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-white/50 dark:bg-gray-800/50 rounded-xl backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 hover:scale-105 transition-transform hover:text-primary-500 text-sm sm:text-base">
