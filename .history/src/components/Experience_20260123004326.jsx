              ...
              >
                ...
                <div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 -translate-y-1 z-20">
                  <div className="relative">
                    ...
                    {/* Main indicator */}
                    <div className={`absolute inset-1 w-6 h-6 rounded-full bg-gradient-to-r ${job.type === 'current' ? 'from-green-500 to-emerald-600' : 'from-primary-500 to-primary-700'} shadow-lg flex items-center justify-center`}>
                      {/* Inner dot */}
                    ...
                    {job.type === 'current' && (
                      <div className="absolute -top-1 -right-1 w-3 h-3 bg-green-400 rounded-full animate-pulse border-2 border-white dark:border-dark-900"></div>
                    )}
                  </div>
                </div>
