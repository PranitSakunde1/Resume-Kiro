...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-20 bg-gradient-to-br from-gray-50/50 via-white/50 to-purple-50/50 dark:from-dark-800/50 dark:via-dark-900/50 dark:to-dark-800/50 relative overflow-hidden">
